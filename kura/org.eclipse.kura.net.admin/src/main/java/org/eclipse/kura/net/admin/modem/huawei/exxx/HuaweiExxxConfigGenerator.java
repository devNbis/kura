...
public class HuaweiExxxConfigGenerator implements ModemPppConfigGenerator {
	...
	public ModemXchangeScript getConnectScript(ModemConfig modemConfig) {
        ...
        modemXchange.addmodemXchangePair(new ModemXchangePair("\"ATZ\"", "OK"));
        modemXchange.addmodemXchangePair(new ModemXchangePair("\"ATQ0 V1 E1 S0=0 &C1 &D2 +FCLASS=0\"", "OK"));     
    ...
    private String formPDPcontext(int pdpPid, PdpType pdpType, String apn) {
        ...
        StringBuffer pdpcontext = new StringBuffer(HuaweiExxxAtCommands.pdpContext.getCommand());
        pdpcontext.append('=');
