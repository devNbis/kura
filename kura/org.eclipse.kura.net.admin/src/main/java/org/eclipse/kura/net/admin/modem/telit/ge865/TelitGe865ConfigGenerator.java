...
public class TelitGe865ConfigGenerator implements ModemPppConfigGenerator {
    ...
    private String formPDPcontext(int pdpPid, PdpType pdpType, String apn) {
        ...
        StringBuffer pdpcontext = new StringBuffer(TelitGe865AtCommands.pdpContext.getCommand());
        pdpcontext.append('=');
